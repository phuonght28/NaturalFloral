...
let createEntitlementsFile = (() => {
  var _ref5 = _asyncToGenerator(function* ({ generatedEntitlementsPath, plistData, archivePath }) {
    ...
    let generatedEntitlements = (_lodash || _load_lodash()).default.pickBy(entitlements, function (val, key) {
      return !(_lodash || _load_lodash()).default.includes(blacklistedEntitlementKeys, key);
    });
    generatedEntitlements[icloudContainerEnvKey] = generatedEntitlements[icloudContainerEnvKey] ? generatedEntitlements[icloudContainerEnvKey].filter(function (i) {
      return i === 'Production';
    }) : [];
