...
import { uuid4, errorAlert } from '../services/config'
import { Auth } from '../services/Firebase/Auth'
const UNIQUE_HANDLER_ID = uuid4()

import { AppNotificaton } from '../constants/StyledText'
// import Redux, { createStore } from 'redux'
// const reduxStore = createStore(counter)

// import { REDUXSTORE } from '../constants/Layout'
// const valueREDUXSTORE = REDUXSTORE()
...
export default class PlantesList extends Component {
  ...
  render() {
    ...
    //   console.log(' ===================================================================== valueREDUXSTORE', reduxStore.getState())
    // })
    ...
    return (
      <Container style={{ backgroundColor: "#f1f2f7" }}>
        ...
        {/* <AppNotificaton type='warning'>fdfdfsdfsdf {this.state.countTest} sads </AppNotificaton> */}
        <View style={cssWidget.block} >
          ...
          <Button style={[css.boxShadow, cssWidget.button]} onPress={() => this._onPress("Discussion")}>
            <Icon style={cssWidget.icon} type="MaterialIcons" name="forum" />
          </Button>
        </View>
