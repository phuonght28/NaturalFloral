...
import RenderChat from './ClubFlora/_sbRenderChat'
        ...
        <Container style={{ flex: 1 }}>
          ...
          {Platform.OS === "ios" &&
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={behavior} enabled >
              <ScrollableTabView renderTabBar={this._renderTab} >
                <Container key={'Détail'} tabLabel={'Détail'} style={{ backgroundColor: '#FFFFFF' }}>
                  <ScrollView style={{ flex: 1 }} onScroll={this.handleScroll} scrollEventThrottle={100} >
                ...
                <Container key={'Discussion'} tabLabel={'Discussion'} style={{ backgroundColor: '#FFFFFF' }}>
                  <RenderChat
                    navigation={this.props.navigation}
                    channelUrl={this.propsPlanteID.replace("-", "")}
                    inFrame={true}
                    isOpenChannel={true}
          ...
          {Platform.OS !== "ios" &&
            <ScrollableTabView renderTabBar={this._renderTab} >
              ...
              <Container key={'Discussion 2'} tabLabel={'Discussion'} style={{ backgroundColor: '#FFFFFF' }}>
                <RenderChat
                  navigation={this.props.navigation}
                  channelUrl={this.propsPlanteID.replace("-", "")}
                  inFrame={true}
