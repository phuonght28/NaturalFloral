      ...
      <Container>
        ...
        <Content padder style={{ backgroundColor: "#FFF" }}>
          ...
          <View style={TextStyle.paragraph}>
            ...
            <Text style={TextStyle.line}>{`Laboratoires Scientia Natura offre gratuitement aux Utilisateurs l’accès et l'utilisation de l’Application NATWAY afin de profiter des services suivants (ci-après dénommés les « Services ») :`}</Text>
            ...
            <Text style={TextStyle.line}>{`L’application NATWAY propose l’aide d’un Professionnel lors d’un achat de complément alimentaire. L’Utilisateur accepte donc d’être contacté par NATWAY ou par le Professionnel concerné afin de répondre a ces questions. A cet effet, l’Utilisateur est informé et accepte que ses données à caractère personnel soient communiquées au Professionnel concerné.`}</Text>
            ...
            <Text style={TextStyle.line}>{`L’Application permet à l'Utilisateur de se mettre en relation avec des professionnels de médecine conventionnelles ou bien-être. L’utilisateur pourra rechercher et acheter des Consultations ou ateliers de médecines non conventionnelles ou bien-être auprès des Professionnels inscrits sur NATWAY  (ci-après les « Consultations »).`}</Text>
            <Text style={TextStyle.line}>{`Lorsque l’Utilisateur procède à la réservation d’une Consultation sur l’Application, la prise de rendez-vous est faite par l'intermédiaire de NATWAY. L’Utilisateur accepte donc d’être contacté par NATWAY ou par le Professionnel concerné afin de fixer le rendez-vous. A cet effet, l’Utilisateur est informé et accepte que ses données à caractère personnel soient communiquées au Professionnel concerné.`}</Text>
            <Text style={TextStyle.line}>{`La disponibilité d’une Consultation est précisée au moment de la demande de rendez-vous effectuée par l’Utilisateur. Cette information est donnée à titre indicatif. NATWAY ne garantit en aucune manière celle-ci, le Professionnel concerné pouvant seul confirmer sa disponibilité à une date précise.`}</Text>
            <Text style={TextStyle.line}>{`NATWAY n’agissant qu’en qualité de simple intermédiaire entre l’Utilisateur et les Professionnels, tout différend pouvant s’élever entre l’Utilisateur et le Professionnel doit être traité directement entre eux.`}</Text>
            ...
            <Text style={TextStyle.line}>{`NATWAY permet d’échanger des messages instantanés privés électroniques entre Professionnels et entre Professionnel et Utilisateurs.`}</Text>
            <Text style={TextStyle.line}>{`Les utilisatrices et les utilisateurs de NATWAY se garderont de divulguer leurs codes d'accès. Chaque Utilisateur et Professionnel peut modifier son mot de passe à tout moment. Les Utilisateurs et Professionnels sont responsables des propos, discussion et échanges de documents qu'ils publient et doivent donc veiller à ce que les droits de tiers ne soient pas violés (par exemple droits immatériels, droits d'auteur ou droits liés à la protection de la personnalité). Laboratoires Scientia Natura décline toute responsabilité quant aux contenus et à la licéité des fichiers qui sont envoyés, reçus ou publiés sous quelque forme que ce soit par les Utilisateur et Professionnel de NATWAY; ceci s'applique aux textes, mais également aux images, aux sons, à tous les liens et à toutes les adresses électroniques.`}</Text>
            <Text style={TextStyle.line}>{`Les membres de NATWAY s'engagent à ne pas diffuser ou conserver sur la plate-forme des informations contraires au droit ou à la morale. Cette restriction concerne également d'éventuels liens pointant sur des sites Web dont le contenu serait illicite.`}</Text>
            <Text style={TextStyle.line}>{`Les informations contenues dans ce Application ne lient pas contractuellement Laboratoires Scientia Natura.`}</Text>
          </View>
          <View style={TextStyle.paragraph}>
            <Text style={TextStyle.Heading1}>{`Article 3 : Utilisation des services de NATWAY`}</Text>
            ...
            <Text style={TextStyle.line}>{`- adhésion à la charte utilisateur de NATWAY*`}</Text>
            ...
            <Text style={TextStyle.Heading2}>{`Tout nouveau professionnel doit être coopté par un professionnel existant et enregistrée sur NATWAY. Le cooptage peut se faire via Linkedin ou rencontre physique.`}</Text>
            ...
            <Text style={TextStyle.line}>{`- adhésion à la charte Professionnel de NATWAY\n- nom : - prénom : - date de naissance -numéro de téléphone (si possible mobile) \n- nom de l’ecole de formation \n-Copie de du diplôme obtenu et date d’obtention \n- Année d’expérience`}</Text>
            <Text style={TextStyle.Heading2}>{`3.2. Paiement de la Consultation`}</Text>
            <Text style={TextStyle.line}>{`Toute Consultation réservée par l’Utilisateur auprès de NATWAY sera réglée sur l’application. Un retributionprès du Professionnel lors de la Consultation.`}</Text>
            ...
            <Text style={TextStyle.line}>{`Lorsque vous utilisez la Application pour des Trajets transfrontaliers ou hors de France, les Frais de Services peuvent être facturés par une société affiliée de NATWAY éditant la Application locale.`}</Text>
            <Text style={TextStyle.Heading3}>{`5.3. Arrondis`}</Text>
            <Text style={TextStyle.line}>{`Vous reconnaissez et acceptez que NATWAY peut, à son entière discrétion, arrondir au chiffre inférieur ou supérieur les Frais de Service et la Participation aux Frais.`}</Text>
            ...
            <Text style={TextStyle.line}>{`En utilisant la Application en tant que Conducteur pour des Trajets avec Réservation, vous confiez à NATWAY un mandat d’encaissement du montant de la Participation aux Frais en votre nom et pour votre compte.`}</Text>
            <Text style={TextStyle.line}>{`Par conséquent, dans le cadre d’un Trajet en Covoiturage, et après acceptation manuelle ou automatique de la Réservation, NATWAY encaisse la totalité de la somme versée par le Passager (Frais de Service et Participation aux Frais).`}</Text>
            <Text style={TextStyle.line}>{`Les Participations aux Frais reçues par NATWAY sont déposées sur un compte dédié au paiement des Conducteurs.`}</Text>
            <Text style={TextStyle.line}>{`Vous reconnaissez et acceptez qu’aucune des sommes perçues par NATWAY au nom et pour le compte du Conducteur n’emporte droit à intérêts. Vous acceptez de répondre avec diligences à toute demande de NATWAY et plus généralement de toute autorité administrative ou judiciaire compétente en particulier en matière de prévention ou la lutte contre le blanchiment. Notamment, vous acceptez de fournir, sur simple demande, tout justificatif d’adresse et/ou d’identité utile.`}</Text>
            <Text style={TextStyle.line}>{`En l’absence de réponse de votre part à ces demandes, NATWAY pourra prendre toute mesure qui lui semblera appropriée notamment le gel des sommes versées et/ou la suspension de votre Compte et/ou la résiliation des présentes CGU.`}</Text>
            <Text style={TextStyle.Heading2}>{`5.4.2. Versement de la Participation aux Frais au Conducteur`}</Text>
            <Text style={TextStyle.line}>{`A la suite du Trajet en Covoiturage, les Passagers disposent d’un délai de 24 heures pour présenter une réclamation à NATWAY . En l’absence de contestation de leur part dans cette période, NATWAY considère la confirmation du Trajet comme acquise.`}</Text>
            ...
            <Text style={TextStyle.line}>{`Lorsque le Trajet en Covoiturage est confirmé par le Passager, vous avez la possibilité, en tant que Conducteur, de donner instructions à NATWAY de vous verser l’argent sur votre compte bancaire (en renseignant sur votre Compte, au préalable, vos coordonnées bancaires) ou votre compte Paypal (en renseignant sur votre Compte, au préalable, votre adresse email Paypal).`}</Text>
            <Text style={TextStyle.line}>{`L’ordre de virement à votre nom sera transmis le premier jour ouvré suivant votre demande ou à défaut de demande de votre part, le premier jour ouvré suivant la mise à disposition sur votre profil des sommes concernées (sous réserve que NATWAY dispose de vos informations bancaires).`}</Text>
            <Text style={TextStyle.line}>{`A l’issue du délai de prescription de 5 ans applicable, toute somme non réclamée à NATWAY sera réputée appartenir à NATWAY.`}</Text>
            <Text style={TextStyle.Heading2}>{`5.4.3. Versement du Prix à l’Autocariste`}</Text>
            <Text style={TextStyle.line}>{`A la suite du Trajet en Bus, vous disposez d’un délai de 24 heures pour présenter une réclamation à NATWAY. En l’absence de contestation de votre part, NATWAY considère la confirmation du Trajet en Bus comme acquise et versera le Prix à l’Autocariste.`}</Text>
          </View>
          <View style={TextStyle.paragraph}>
            ...
            <Text style={TextStyle.line}>{`Si toutefois l'Utilisateur note qu'une information fournie par le Professionnel sur le Application était incorrecte, ou que le Professionnel ne respecte pas le code de déontologie du Application, il est encouragé à le faire savoir au plus vite par email à hello@NATWAY.com`}</Text>
          ...
          <View style={TextStyle.paragraph}>
            ...
            <Text style={TextStyle.Heading2}>{`11.1. Contenu publié par NATWAY`}</Text>
            <Text style={TextStyle.line}>{`Sous réserve des contenus fournis par ses Membres, NATWAY est seule titulaire de l’ensemble des droits de propriété intellectuelle afférents au Service, à la Application, à son contenu (notamment les textes, images, dessins, logos, vidéos, sons, données, graphiques) ainsi qu’aux logiciels et bases de données assurant leur fonctionnement.`}</Text>
            <Text style={TextStyle.line}>{`NATWAY vous accorde une licence non exclusive, personnelle et non cessible d’utilisation de la Application et des Services, pour votre usage personnel et privé, à titre non commercial et conformément aux finalités de la Application et des Services.`}</Text>
            <Text style={TextStyle.line}>{`Vous vous interdisez toute autre utilisation ou exploitation de la Application et des Services, et de leur contenu sans l’autorisation préalable écrite de NATWAY. Notamment, vous vous interdisez de :`}</Text>
            <Text style={TextStyle.bullet}>{`■  (i) reproduire, modifier, adapter, distribuer, représenter publiquement, diffuser la Application, les Services et leur contenu, à l’exception de ce qui est expressément autorisé par NATWAY ;`}</Text>
            ...
            <Text style={TextStyle.line}>{`Afin de permettre la fourniture des Services et conformément à la finalité de l’Application, vous concédez à NATWAY une licence non exclusive d’utilisation des contenus et données que vous fournissez dans le cadre de votre utilisation des Services (ci-après, votre « Contenu Membre »). Afin de permettre à NATWAY la diffusion par réseau numérique et selon tout protocole de communication, (notamment Internet et réseau mobile), ainsi que la mise à disposition au public du contenu de l’Application, vous autorisez NATWAY, pour le monde entier et pour toute la durée de votre relation contractuelle avec NATWAY, à reproduire, représenter, adapter et traduire votre Contenu Membre de la façon suivante :`}</Text>
            <Text style={TextStyle.bullet}>{`■  (i) vous autorisez NATWAY à reproduire tout ou partie de votre Contenu Membre sur tout support d’enregistrement numérique, connu ou inconnu à ce jour, et notamment sur tout serveur, disque dur, carte mémoire, ou tout autre support équivalent, en tout format et par tout procédé connu et inconnu à ce jour, dans la mesure nécessaire à toute opération de stockage, sauvegarde, transmission ou téléchargement lié au fonctionnement de la Application et à la fourniture du Service ;`}</Text>
            <Text style={TextStyle.bullet}>{`■  (ii) vous autorisez NATWAY à adapter et traduire votre Contenu Membre, ainsi qu’à reproduire ces adaptations sur tout support numérique, actuel ou futur, stipulé au (i) ci-dessus, dans le but de fournir les Services, notamment en différentes langues. Ce droit comprend notamment la faculté de réaliser, dans le respect de votre droit moral, des modifications de la mise en forme de votre Contenu Membre aux fins de respecter la charte graphique de l’Application et/ou de le rendre techniquement compatible en vue de sa publication via la Application.`}</Text>
          </View>
          <View style={TextStyle.paragraph}>
          ...
          <View style={TextStyle.paragraph}>
            ...
            <Text style={TextStyle.line}>{`Soit par message électronique à l'adresse donnees@NATWAY.com`}</Text>
            ...
            <Text style={TextStyle.line}>{`L'Utilisateur accepte que Laboratoires Scientia Natura puisse leur envoyer des informations relatives à son activité, ou des offres promotionnelles de certains de ses partenaires. Si l'Utilisateur souhaite ne plus recevoir ce type d'information, il peut en faire la demande par simple email à donnees@NATWAY.eu`}</Text>
          </View>
          <View style={TextStyle.paragraph}>
